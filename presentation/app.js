...
function mission(){
 if(beat===0)return `<div class="project-mission mission-service"><div class="project-kicker">TRAVELS / RURAL MOBILITY SERVICE</div><div class="platform-overview"><div class="platform-strip" aria-label="Selected research vehicle examples from the broader collaboration"><figure class="platform-frame"><img src="assets/uga-research-vehicle.png" alt="Sensor-equipped passenger research vehicle" width="719" height="539" decoding="async"></figure><figure class="platform-frame"><img src="assets/uw-research-van.png" alt="Sensor-equipped research van" width="1024" height="1024" decoding="async"></figure><p class="platform-note">Selected research platforms · examples from the broader collaboration</p></div><div class="service-question"><span>THE QUESTION</span><strong>What are the needs in rural mobility?</strong><p>Based on identified community needs, connect the AV tech, the service, and the evidence.</p></div></div><div class="service-path" aria-label="Review logic"><div><b>01</b><strong>Community needs</strong><span>Where and why people travel</span></div><div><b>02</b><strong>Service design</strong><span>How trips are organized and supported</span></div><div><b>03</b><strong>Technical evidence</strong><span>What works, where and under which limits</span></div></div><div class="mission-services" aria-label="Example rural mobility needs"><span>Healthcare access</span><span>Work and daily needs</span><span>Tourism and events</span></div><div class="caption">A service-level framing for the literature review.</div></div>`;
